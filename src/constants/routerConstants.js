...
export const StakingView = `${RootPath}/staking`
export const PresalePath = `${RootPath}/presale`
export const PrivateSalePath = `${RootPath}/privatesale`
export const InvestPath = `${RootPath}/investments`
